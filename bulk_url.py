...
# ========== USER CONFIGURATION ==========
ESA_HOST = "x.x.x.x:6080"  # ESA Hostname/IP, e.g. 10.1.1.25:6080 supported over API HTTP(6080) currently 
USERNAME = "xxxxx"  # Plain-text username
PASSWORD = "xxxxx"  # Plain-text password
DICTIONARY_NAME = "xxxxxx"  # Dictionary to update, example "URL-Blocklist"

WORDS_TO_ADD_CSV = "xxxxxxxxxx.com"  # Comma-separated words, example "test.com, url.com"
